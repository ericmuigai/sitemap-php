...
class Sitemap {
     ...
     * @param string $style
     */
    public function __construct($domain, $style = "") {
    ...
    /**
     * sets stylesheet to the $style
     * @param $style string link to stylesheet
     * @return $this
     */
    ...
    private function startSitemap() {
        ...
        if($this->getStyle() != '') {
            $this->getWriter()->writePi('xml-stylesheet', 'type="text/xsl" href="'.$this->getStyle().'"');
        }
